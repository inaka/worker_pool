...
handle_cast(crash, _State) -> error(crash_requested);
...
handle_call(crash, _From, _State) -> error(crash_requested);
handle_call(Call, _From, State) -> {reply, Call, State}.
